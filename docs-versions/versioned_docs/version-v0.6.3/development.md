...
[`../website-docusaurus`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/website-docusaurus). It uses Docusaurus, generates
docs pages from `website-docusaurus/docs-tree.yaml`, and is deployed by
[`../.github/workflows/pages.yml`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/.github/workflows/pages.yml).
...
The Astro + Starlight comparison site remains under [`../website`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/website).
...
The root [`docs`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/docs) directory is the source of truth for generated website
docs. When adding or renaming public docs pages, update both:

- [`../website-docusaurus/docs-tree.yaml`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/website-docusaurus/docs-tree.yaml)
- [`../website/docs-tree.yaml`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/website/docs-tree.yaml)

Schemas under [`../schemas`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/schemas) are copied into the static site during
...
docs stay in [`docs`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/docs), while released snapshots are committed under
[`../docs-versions`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/docs-versions).

Docusaurus expects `versions.json`, `versioned_docs`, and `versioned_sidebars`
inside the website directory, so
[`../website-docusaurus/scripts/sync-versioned-inputs.mjs`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/website-docusaurus/scripts/sync-versioned-inputs.mjs)
...
1. Update the current docs version in
   [`../website-docusaurus/docusaurus.config.ts`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/website-docusaurus/docusaurus.config.ts).
2. Add the previous current version to `publishedVersions` in
   [`../website-docusaurus/scripts/sync-versioned-docs.mjs`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/website-docusaurus/scripts/sync-versioned-docs.mjs)
...
released documentation before editing root [`docs`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.3/docs). In practice, finish and
