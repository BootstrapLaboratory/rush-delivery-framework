...
- [AI architecture](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.5/docs/ai/architecture.md): high-level design map for future
  coding agents.
- [AI conventions](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.5/docs/ai/conventions.md): contribution rules and invariants.

## Source Of Truth

The schemas under [`../schemas`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.5/schemas) are the field-level metadata
...
- `https://bootstraplaboratory.github.io/rush-delivery/schemas/v0.6.5/<schema>.schema.json`
