...
[`../schemas`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.7/schemas).

For editor integration in external projects, prefer exact versioned schema
URLs. For example:

```yaml
# yaml-language-server: $schema=https://bootstraplaboratory.github.io/rush-delivery/schemas/v0.6.7/deploy-target.schema.json
```

The root `https://bootstraplaboratory.github.io/rush-delivery/schemas/` URLs
track the current release. Exact paths such as `/schemas/v0.6.7/...` are the
...
Schema:
[`../schemas/npm-release.schema.json`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.7/schemas/npm-release.schema.json)
...
Schema:
[`../schemas/deploy-services-mesh.schema.json`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.7/schemas/deploy-services-mesh.schema.json)
...
Schema:
[`../schemas/deploy-target.schema.json`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.7/schemas/deploy-target.schema.json)
...
Schema:
[`../schemas/package-target.schema.json`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.7/schemas/package-target.schema.json)
...
Schema:
[`../schemas/validation-target.schema.json`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.7/schemas/validation-target.schema.json)
...
Schema:
[`../schemas/toolchain-image-providers.schema.json`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.7/schemas/toolchain-image-providers.schema.json)
...
Schema:
[`../schemas/rush-cache-providers.schema.json`](https://github.com/BootstrapLaboratory/rush-delivery/blob/v0.6.7/schemas/rush-cache-providers.schema.json)
